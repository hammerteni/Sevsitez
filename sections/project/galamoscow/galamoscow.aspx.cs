...
namespace site.sections.project.galamoscow
{
    /// <summary>Страница Гала-концерт в Москве (подраздел - Этапы Образовательного
    /// проекта "Воссоединение Крыма с Россией")</summary>
    public partial class galamoscow : System.Web.UI.Page
    {
        ...
        private void PageFill(string p = "")
        {
            ...
            if (p == "") form.UniverseFillPage(addPanel, "galaMoscow", PagesFormE.CacheContr.NoCache);

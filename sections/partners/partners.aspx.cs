...
namespace site.sections.partners
{
    /// <summary>Страница с информацией о партнёрах</summary>
    public partial class partners : System.Web.UI.Page
    {
        ...
        private void PageFill(string p = "")
        {
            ...
            if (p == "") form.UniverseFillPage(addPanel, "partners", PagesFormE.CacheContr.NoCache);

...
namespace site.adm
{
    ...
    public partial class consevents : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ((LinkButton)Master.FindControl("lBtnToConsEvents")).ApplyStyle(s);
        ...
        private void PageFilling()
        {
            ...
            addPanel.Controls.Add(optionForm.GetEventFilterPanel());
            addPanel.Controls.Add(optionForm.GetEventListTbl(CountOfElemInOnePage));
        }

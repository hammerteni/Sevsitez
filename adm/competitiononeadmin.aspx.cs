...
namespace site.adm
{
    ...
    public partial class competitiononeadmin : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ((LinkButton)Master.FindControl("lBtnCompetitionAdmin")).ApplyStyle(s);
        ...
        private void PageFilling(string requestNum, string rights)
        {
            ...
            addPanel.Controls.Add(form.ConsoleCompetitionOnePanel_admin(requestNum, "администратор", true));
        }
    }
}